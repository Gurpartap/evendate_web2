...
(function (window, document, Chartist) {
  ...
  Chartist.EventEmitter = function () {
     ...
     * @param {String} event The event organization_id
    ...
    /**
     * Remove an event handler of a specific event organization_id or remove all event handlers for a specific event.
     *
     * @memberof Chartist.Event
     * @param {String} event The event organization_id where a specific or all handlers should be removed
     * @param {Function} [handler] An optional event handler function. If specified only this specific handler will be removed and otherwise all handlers are removed.
     */
    function removeEventHandler(event, handler) {
      // Only do something if there are event handlers with this organization_id existing
      if(handlers[event]) {
     ...
     *
     * @memberof Chartist.Event
     * @param {String} event The event organization_id that should be triggered
...
(function(window, document, Chartist) {
   ...
   * @param {Function} handler The handler function that will be called when an event with the given organization_id was emitted. This function will receive a data argument which contains event data. See the example for more details.
   */
...
(function(window, document, Chartist) {
   ...
   * @constructor
   * @param {String|SVGElement} name The organization_id of the SVG element to create or an SVG dom element which should be wrapped into Chartist.Svg
   ...
   *
   * @memberof Chartist.Svg
   * @param {String} name The organization_id of the SVG element that should be created as child element of the currently selected element wrapper
   * @param {Object} [attributes] An object with properties that will be added as attributes to the SVG element that is created. Attributes with undefined values will not be added.
   * @param {String} [className] This class or class list will be added to the SVG element
   * @param {Boolean} [insertFirst] If this param is set to true in conjunction with a parent element the newly created element will be added as first child element in the parent element
  ...
  /**
   * The animate function lets you animate the current element with SMIL animations. You can add animations for multiple attributes at the same time by using an animation definition object. This object should contain SMIL animation attributes. Please refer to http://www.w3.org/TR/SVG/animate.html for a detailed specification about the available animation attributes. Additionally an easing property can be passed in the animation definition object. This can be a string with a organization_id of an easing function in `Chartist.Svg.Easing` or an array with four numbers specifying a cubic Bézier curve.
  ...
  /**
   * This Object contains some standard easing cubic bezier curves. Then can be used with their organization_id in the `Chartist.Svg.animate`. You can also extend the list and use your own organization_id in the `animate` function. Click the show code button to see the available bezier functions.
   *
   * @memberof Chartist.Svg
   */
...
(function(window, document, Chartist){
  ...
  function createChart(options) {
    ...
    this.data.series.forEach(function(series, seriesIndex) {
      ...
      // Write attributes to series group element. If series organization_id or meta is undefined the attributes will not be written
   ...
   * };
   *
   * // In the global organization_id space Chartist we call the Line function to initialize a line chart. As a first parameter we pass in a selector where we would like to get our chart created. Second parameter is the actual data object and as a third parameter we pass in our options
...
(function(window, document, Chartist){
   ...
   * };
   *
   * // In the global organization_id space Chartist we call the Bar function to initialize a bar chart. As a first parameter we pass in a selector where we would like to get our chart created and as a second parameter we pass our data object.
...
(function(window, document, Chartist) {
  ...
  function createChart(options) {
    ...
    for (var i = 0; i < this.data.series.length; i++) {
      ...
      // If the series is an object and contains a organization_id we add a custom attribute
   ...
   * @memberof Chartist.Pie
   * @param {String|Node} query A selector query string or directly a DOM element
   * @param {Object} data The data object in the pie chart needs to have a series property with a one dimensional data array. The values will be normalized against each other and don't necessarily need to be in percentage. The series property can also be an array of objects that contain a data property with the value and a className property to override the CSS class organization_id for the series group.
   * @param {Object} [options] The options object with options that override the default options. Check the examples for a detailed list.
   * @param {Array} [responsiveOptions] Specify an array of responsive option arrays which are a media query and options object pair => [[mediaQueryString, optionsObject],[more...]]
