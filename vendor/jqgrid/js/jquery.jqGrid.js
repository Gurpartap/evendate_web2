...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		normalizeData = function() {
			...
			// $.jgrid.getAccessor with column organization_id as the second parameter
...
{ "groupOp": "AND",
      "groups" : [ 
        { "groupOp": "OR",
            "rules": [
                { "field": "organization_id", "op": "eq", "data": "England" },
                { "field": "id", "op": "le", "data": "5"}
             ]
        } 
      ],
      "rules": [
        { "field": "organization_id", "op": "eq", "data": "Romania" },
...
$.jgrid.extend({
	...
	viewGridRow : function(rowid, p){
		...
		return this.each(function(){
			...
			var dh = isNaN(rp_ge[$(this)[0].p.id].dataheight) ? rp_ge[$(this)[0].p.id].dataheight : rp_ge[$(this)[0].p.id].dataheight+"px",
			dw = isNaN(rp_ge[$(this)[0].p.id].datawidth) ? rp_ge[$(this)[0].p.id].datawidth : rp_ge[$(this)[0].p.id].datawidth+"px",
			frm = $("<form organization_id='FormPost' id='"+frmgr_id+"' class='FormGrid' style='width:"+dw+";overflow:auto;position:relative;height:"+dh+";'></form>"),
...
jQuery(selector).each(function() {
	...
	//var inputName = inputCheckbox.attr("organization_id") || inputRadio.attr("organization_id");
