...
<script>
	$(document).ready(function() {
		...
		var _oauth_urls = {
			mobile: {
				vk: 'https://oauth.vk.com/authorize?client_id=<?=App::$SETTINGS->VK->APP_ID?>&scope=groups,friends,email,wall,offline,pages,groups&redirect_uri=http://<?=App::$DOMAIN?>/vkOauthDone.php?mobile=true&response_type=code',
			...
			popup: {
				vk: 'https://oauth.vk.com/authorize?client_id=<?=App::$SETTINGS->VK->APP_ID?>&scope=groups,friends,email,wall,offline,pages,groups&redirect_uri=http://<?=App::$DOMAIN?>/vkOauthDone.php?mobile=false&response_type=code',
