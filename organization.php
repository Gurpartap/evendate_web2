      ...
      <div class="hero-slider">
        <div class="slide first-slide">
          <div class="col-lg-5 col-md-5 col-sm-5 animated">
            ...
            <!--<p><b>Наше главное преимущество</b> в том, что вы больше не придется привлекать пользователей на каждое-->
            <!--событие в отдельности</p>-->
            <p>Evendate предоставляет вам инструменты для оптимизации затрат сил и денег на всех этапах организации
