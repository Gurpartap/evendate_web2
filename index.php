...
?>
	...
	<header class="header_evendate">
		...
		<div class="header_button_container"><button id="go" class="header_button" type="button"><span class="header_button_text">ВОЙТИ</span></button></div></header>
		...
		<section>
			...
			<div>
				<div class="who_use_container">
					<div>
						<a href="users.php" class="who_use_head_blue for_users_hover">Пользователи <i class="fa fa-angle-right"></i></a>
					</div>
...
и получай уведомления, чтобы ничего не пропустить.</span></div>
				</div><div class="who_use_container">
					<div>
						<a href="organizations.php" class="who_use_head_pink who_use_head_blue for_org_hover">Организаторы <i class="fa fa-angle-right"></i></a>
					</div>
					<div class="who_use_text_container"><span class="who_use_text">Привлекайте и удерживайте целевую аудиторию. Размещайте события, находите потенциальных клиентов, общайтесь с участниками,  получайте аналитику по проведенным мероприятиям.</span></div>
				</div>
			</div>
