...
<head>
	...
	if ($DEBUG_MODE) { ?>
		...
		<link rel="stylesheet" href="/dist/app.css?rev=abad40ce8695ba0c2085a92ec8e228ca"><?php
	} else { ?>
...
if($DEBUG_MODE) { ?>
	...
	<script type="text/javascript" src="/dist/app.js?rev=7fbcbc0836dc51278b18d069bf7ba975" charset="utf-8"></script><?php
} else { ?>
