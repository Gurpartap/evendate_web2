...
<section ng-hide="!edit_mode && !data.custom.enabled" class="testimonials testimonials-4 padding-120-75" id="custom-html"
  ...
  <div class="container">
    ...
    <div class="row">
      <textarea class="textarea-html" ng-if="edit_mode"></textarea>
    </div>  <!-- /.row -->
  </div>
</section>
        ...
        <div class="board-backgrounds-section-tiles u-clearfix">
          ...
          <div class="board-backgrounds-section-tile board-backgrounds-photos-tile js-bg-photos">
            <div ngf-select=""
                 ...
                 ngf-drop-available="dropAvailable"
                 style="background-image: url({{main_background.$ngfBlobUrl ? main_background.$ngfBlobUrl : default_img}})">
            </div>
        ...
        <div class="demo-style-switch" id="switch-style" style="left: 0px;">
          <div class="switched-options">
            ...
            <ul class="styles">
              ...
              <li>
                <input type="color" id="html5colorpicker" ng-model="color_scheme" ng-change="setGlobalColor()"
        ...
        <div class="board-backgrounds-section-tiles u-clearfix">
          ...
          <div class="board-backgrounds-section-tile board-backgrounds-photos-tile js-bg-photos">
            <div ngf-select=""
                 ...
                 class="image drop-box ng-pristine ng-valid thumb"
                 ngf-drop-available="dropAvailable"
                 style="background-image: url({{gallery_background.$ngfBlobUrl ? gallery_background.$ngfBlobUrl : default_img}})">
            </div>
            <div class="title" style="">Загрузить</div>
          </div>
        </div>
