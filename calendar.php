...
<?php
if($DEBUG_MODE) { ?>
	<script type="text/javascript" src="/dist/vendor.js?rev=16e2d1ba6905fffdf9dbbd455a33caed" charset="utf-8"></script>
	<script type="text/javascript" src="/dist/app.js?rev=54bba7c640ef9db33c2a310665a0da55" charset="utf-8"></script><?php
} else { ?>
