            ...
            <div class="page_wrapper">
                ...
                <div id="user_bar" class="-unselectable">
                    <div class="avatar_block">
                        <div class="avatar -size_small -rounded -bordered"><img src="<?= $user->getAvatarUrl() ?>">
                        </div>
                        <span class="avatar_name"
                              title="<?= $user->getLastName() . ' ' . $user->getFirstName() ?>"><?= $user->getLastName() . ' ' . $user->getFirstName() ?></span>
                    </div>
                    <div class="user_bar_forhead">
                        ...
                        <div class="user_bar_buttons">
                            ...
                            <button class="button -color_neutral_secondary RippleEffect LogoutButton" type="button">
                                <span class="Text">Выйти</span></button>
                        </div>
                    </div>
                </div>
            </div>
...
<aside id="main_sidebar" class="-unselectable">
    ...
    <div class="sidebar_main_wrapper scrollbar-outer SidebarScroll">
        <nav class="sidebar_navigation SidebarNav">
            ...
            <div class="sidebar_navigation_item <?= $edit_event_btn_hidden ?> SidebarNavItem" data-page="edit_event"
                 data-title="Создать событие"><span>Создать событие</span></div>
            <div class="sidebar_navigation_item SidebarNavItem" data-page="feed" data-feed_state="actual"
                 data-title="События"><span>События</span><span
                    class="counter sidebar_navigation_counter -color_marginal -hidden SidebarNavFeedCounter">50</span>
            </div>
            <div class="sidebar_navigation_item SidebarNavItem" data-page="friends" data-title="Друзья">
                <span>Друзья</span><span
                    class="counter sidebar_navigation_counter -color_marginal -hidden SidebarNavFriendsCounter"></span>
            </div>
            <div class="sidebar_navigation_item SidebarNavItem" data-page="organizations" data-title="Организации">
                <span>Каталог организаторов</span></div>
        </nav>
