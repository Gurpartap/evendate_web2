...
<head>
	...
	if ($DEBUG_MODE) { ?>
		...
		<link rel="stylesheet" href="/dist/app.css?rev=732f15644c06cae37e7bb1aec9e49cd6"><?php
	} else { ?>
...
if($DEBUG_MODE) { ?>
	...
	<script type="text/javascript" src="/dist/app.js?rev=dce94a5b78903385866d2765fe7550ed" charset="utf-8"></script><?php
} else { ?>
