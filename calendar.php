...
<head>
	...
	if($DEBUG_MODE) { ?>
		...
		<link rel="stylesheet" href="/dist/app.css?rev=dce43de960df336255cc0ba6dbb43cd4"><?php
	} else { ?>
...
if($DEBUG_MODE) { ?>
	...
	<script type="text/javascript" src="/dist/app.js?rev=e1b951f1ffd577ad6316d470325add82" charset="utf-8"></script><?php
} else { ?>
