...
class PrivilegesException extends AbstractException{
	...
	public function __construct($message = 'Извините, у вас нет прав для данного действия', PDO $db, $user_message = 'Извините, у вас нет прав для данного действия', $file = '', $file_line = 0){
		if (is_array($message)){
