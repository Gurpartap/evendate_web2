...
CREATE VIEW view_notifications AS
  SELECT
    ...
    DATE_PART('epoch', users_notifications.notification_time::TIMESTAMPTZ) :: INT AS notification_time,
  ...
  SELECT
    ...
    DATE_PART('epoch', events_notifications.notification_time::TIMESTAMPTZ) :: INT AS notification_time,
